...
const Header = () => {
  ...
  const active = 'text-green-600 transition hover:text-green-500/75 p-3 bg-gray-100 rounded-md'
            ...
            <div className="md:flex md:items-center md:gap-12">
              <nav aria-label="Global" className="hidden md:block">
                <ul className="flex items-center gap-6 text-sm">
                  ...
                  <li>
                    <Link className={pathname === '/categories' ? active : inactive} href="/categories">
                      Categories
                    </Link>
                  </li>
                  <li>
